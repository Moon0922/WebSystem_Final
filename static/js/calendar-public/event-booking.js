    ...
    */
    ...
    var CalendarDataManager = /** @class */ (function () {
        ...
        CalendarDataManager.prototype._computeOptionsData = function (optionOverrides, dynamicOptionOverrides, calendarApi) {
            ...
            var _a = this.processRawCalendarOptions(optionOverrides, dynamicOptionOverrides), refinedOptions = _a.refinedOptions, pluginHooks = _a.pluginHooks, localeDefaults = _a.localeDefaults,
        ...
        CalendarDataManager.prototype._computeCurrentViewData = function (viewType, optionsData, optionOverrides, dynamicOptionOverrides) {
            ...
            var _a = this.processRawViewOptions(viewSpec, optionsData.pluginHooks, optionsData.localeDefaults, optionOverrides, dynamicOptionOverrides), refinedOptions = _a.refinedOptions,
                extra = _a.extra;
            warnUnknownOptions(extra);
    ...
    var TableRow = /** @class */ (function (_super) {
        ...
        TableRow.prototype.render = function () {
            ...
            var _b = computeFgSegPlacement(props.cells, props.fgEventSegs, props.dayMaxEvents, props.dayMaxEventRows, state.segHeights, state.maxContentHeight, colCnt, context.options.eventOrder),
                paddingBottoms = _b.paddingBottoms, segsByFirstCol = _b.segsByFirstCol, segsByEachCol = _b.segsByEachCol, segIsHidden = _b.segIsHidden, segTops = _b.segTops,
...
var timesAvailable = ["9:00 am", "10:00 am", "11:00 am", "2:00 pm", "3:00 pm"];

var time = "";
var daySelected = null;
// event.name = document.getElementById("event").textContent;
                ...
                for (var i = 0; i < timesAvailable.length; i++) {
                    ...
                    timeBtn.addEventListener("click", function () {
                        ...
                        confirmBtn.addEventListener("click", function () {
                            document.getElementById("event-time-stamp").textContent = time + " " +
                                days[daySelected.getDay()] + ", " +
                                months[daySelected.getMonth()] + " " +
                                daySelected.getDate();
                            document.getElementById("meeting-date").classList.add("hidden");
                            document.getElementById("meeting-register").classList.remove("hidden");
                        });
                        last = this;
                    });
                }
...
function goBack() {
    document.getElementById("meeting-date").classList.remove("hidden");
    document.getElementById("meeting-register").classList.add("hidden");
}
...
document.getElementById('myForm').addEventListener('submit', function(event) {
    ...
    console.log(daySelected.getFullYear() + "-" +
        ("0" + daySelected.getMonth()).slice(-2) + "-" +
        daySelected.getDate() + "T" + convert12to24(time));
    formDataObj.start_ts = new Date(
